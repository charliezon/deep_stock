...
write_csv(root_dir+'/data/data_buy_follow_index_1/csv/ten_percent/thirty_days/data_sorted.csv', data)
...
data.insert(0, title)
write_csv(root_dir+'/data/data_buy_follow_index_1/csv/ten_percent/thirty_days/data_sorted_weka.csv', data)
